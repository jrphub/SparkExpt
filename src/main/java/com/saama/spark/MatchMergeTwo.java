...
public class MatchMergeTwo{
	...
	public static void main(String[] args) {
		...
		//Logic to know final list of columns should be included
		...
		//column replace is fine, but logic to add new columns in dataframes should be included
		...
		DataFrame allData1 = data1;
		DataFrame allData2 = data2.withColumnRenamed("emp_id","id").withColumnRenamed("emp_name","name").withColumnRenamed("location","city");
		DataFrame allData3 = data3.withColumnRenamed("cust_id","id").withColumnRenamed("cust_name","name").withColumnRenamed("cust_age","age");
		...
		DataFrame bin = allData1.unionAll(allData2).unionAll(allData3);
